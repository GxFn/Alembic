...
4. If there is a current plan, task package, or direct-thread delivery, execute only the content under `../.wakeflow-active/current` explicitly assigned to `Alembic`.
