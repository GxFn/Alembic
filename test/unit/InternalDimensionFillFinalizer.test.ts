      ...
      api: {
        ...
        pcvNodeEvidence: {
          ...
          n11: {
            ...
            gapLimit: null,
            attributedInvalidSourceRefCount: 1,
            ...
            repairedSourceRefs: [
              {
                ...
                rawReason: 'missing-prefix-unique-basename',
            ...
            rejectedCount: 0,
            rejectedSourceRefCount: 1,
            rejectedSourceRefs: [
              {
                normalizedPath: 'src/missing.ts',
                rawReason: 'file-not-found',
                reason: 'file-not-found',
                ref: 'src/missing.ts',
                source: 'agent',
              },
