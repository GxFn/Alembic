...
// POST /candidates/enrich (route I22) was deleted in the Train B DCR wave:
// P0 all-delete verdict, zero external consumers (the only caller was the
// route's own aiProvider fallback; Dashboard has no api method for it).
