...
import { resolveBootstrapTerminalToolset } from '#workflows/deprecated-cold-start/config/BootstrapTerminalToolset.js';
import {
  type BootstrapProjectGraphLike,
  initializeBootstrapRuntime,
} from '#workflows/deprecated-cold-start/context/BootstrapRuntimeInitializer.js';
import { fillDimensionsMock } from '#workflows/deprecated-cold-start/mock/MockBootstrapPipeline.js';
import { completeBootstrapPipeline } from '#workflows/deprecated-cold-start/pipeline/BootstrapCompletionPipeline.js';
import { runBootstrapDimensionSession } from '#workflows/deprecated-cold-start/pipeline/BootstrapDimensionSessionPipeline.js';
  ...
  try {
    ...
    if (db) {
      const { BootstrapSnapshot } = await import(
        '#workflows/deprecated-cold-start/incremental/BootstrapSnapshot.js'
      );
...
export { clearCheckpoints } from '#workflows/deprecated-cold-start/checkpoint/BootstrapCheckpointStore.js';
