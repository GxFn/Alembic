...
import { baseDimensions } from '#workflows/common-capabilities/dimension-planning/BaseDimensions.js';
import type { PhaseReport } from '#workflows/common-capabilities/project-analysis/ProjectAnalysisRunner.js';
...
export async function evaluateProjectAnalysisIncrementalPlan({
  ...
  try {
    const { FileDiffPlanner } = await import(
      '#workflows/common-capabilities/file-diff/FileDiffPlanner.js'
    );
