...
import type { DimensionStat } from '#workflows/common-capabilities/agent-execution/internal/consumers/BootstrapDimensionConsumer.js';
import { cleanupDimensionCheckpoints } from '#workflows/common-capabilities/progress/reports/DimensionCheckpointCleanup.js';
import type {
  PersistWorkflowResultOptions,
  WorkflowResultPersistenceResult,
} from '#workflows/common-capabilities/progress/reports/WorkflowReportTypes.js';
import { writeWorkflowReport } from '#workflows/common-capabilities/progress/reports/WorkflowReportWriter.js';
import {
  createDefaultFileDiffPlanner,
  saveWorkflowSnapshot,
} from '#workflows/common-capabilities/progress/reports/WorkflowSnapshotStore.js';
...
function logBootstrapSummary({
  ...
  candidateResults: import('#workflows/common-capabilities/agent-execution/internal/consumers/BootstrapDimensionConsumer.js').CandidateResults;
  skillResults: import('#workflows/common-capabilities/agent-execution/internal/consumers/BootstrapSkillConsumer.js').SkillResults;
  consolidationResult:
    | import('#workflows/common-capabilities/progress/reports/WorkflowReportTypes.js').WorkflowReportConsolidationResult
    | null;
  skippedDims: string[];
