...
import { BOOTSTRAP_COMPLETE_ACTIONS } from '#workflows/common-capabilities/agent-execution/mission-briefing/BootstrapDimensionText.js';
import { generateSkill as generateWorkflowSkill } from '#workflows/common-capabilities/agent-execution/skills/WorkflowSkillCompletionCapability.js';
import {
...
import { saveDimensionCheckpoint } from '#workflows/common-capabilities/progress/checkpoint/DimensionCheckpointStore.js';
...
async function getActiveExternalWorkflowSession(
  ...
  const { getActiveExternalWorkflowSession } = await import(
    '#workflows/common-capabilities/agent-execution/ExternalMissionWorkflow.js'
  );
