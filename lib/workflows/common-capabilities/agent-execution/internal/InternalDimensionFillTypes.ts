...
import type { BootstrapFileEntry } from '#workflows/common-capabilities/agent-execution/internal/agent-runs/BootstrapDimensionInputBuilder.js';
import type { BootstrapProjectGraphLike } from '#workflows/common-capabilities/agent-execution/internal/context/BootstrapRuntimeInitializer.js';
