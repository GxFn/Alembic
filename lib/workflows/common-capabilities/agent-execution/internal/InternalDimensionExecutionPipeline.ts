...
import { initializeBootstrapRuntime } from '#workflows/common-capabilities/agent-execution/internal/context/BootstrapRuntimeInitializer.js';
import { finalizeInternalDimensionExecution } from '#workflows/common-capabilities/agent-execution/internal/InternalDimensionExecutionFinalizer.js';
import {
  emitInternalDimensionExecutionAiUnavailable,
  prepareInternalDimensionExecutionRun,
} from '#workflows/common-capabilities/agent-execution/internal/InternalDimensionExecutionPreparation.js';
import { runInternalDimensionAgentSession } from '#workflows/common-capabilities/agent-execution/internal/InternalDimensionExecutionSessionRunner.js';
import type {
  InternalDimensionExecutionContainer,
  InternalDimensionExecutionContext,
} from '#workflows/common-capabilities/agent-execution/internal/InternalDimensionExecutionTypes.js';
import { fillDimensionsMock } from '#workflows/common-capabilities/agent-execution/internal/mock/MockBootstrapPipeline.js';
  ...
  try {
    ...
    if (db) {
      const { FileDiffSnapshotStore } = await import(
        '#workflows/common-capabilities/file-diff/FileDiffSnapshotStore.js'
      );
...
export { clearDimensionCheckpoints as clearCheckpoints } from '#workflows/common-capabilities/progress/checkpoint/DimensionCheckpointStore.js';
