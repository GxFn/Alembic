...
export class RulesGenerator {
   ...
   */
  constructor(projectRoot: any, projectName = 'Project') {
   ...
   */
  writeAlwaysOnRules(ruleLines: any) {
    this._ensureDir();
   ...
   */
  writeSmartRules(topic: any, compressedContent: any, description: any) {
    this._ensureDir();
   ...
   * @private
   */
  _renderChannelB(topic: any, body: any, description: any) {
