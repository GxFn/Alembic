 ...
 */
export function checkWriteSafety(filePath: any) {
 ...
 */
export function safeWriteFile(filePath: any, content: any, options: any = {}) {
 ...
 * @returns {{ written: boolean, reason: string, filePath: string }}
 */
export function safeCopyFile(srcPath: any, destPath: any, options: any = {}) {
  const { force = false, logger } = options;
