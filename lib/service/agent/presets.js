    ...
    strategy: {
      ...
      stages: [
        // ── Phase 1: Analyst ──
        {
          ...
          budget: { maxIterations: ANALYST_BUDGET.maxIterations, temperature: 0.4 },
        ...
        // ── Phase 3: Producer ──
        {
          ...
          budget: { maxIterations: PRODUCER_BUDGET.maxIterations, temperature: 0.3 },
          ...
          retryBudget: { maxIterations: 5, temperature: 0.3 },
          retryPromptBuilder: (retryCtx, _origPrompt, prev) => {
