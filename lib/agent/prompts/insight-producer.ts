...
5. 优先调用 submit_with_check 提交；只有明确无需查重时才直接 submit_knowledge
...
- 不新增搜索探索；只在必要时 read_project_file 补齐 Analyst 已指出的证据
- 提交前按顺序使用 check_duplicate、validate_candidate、submit_with_check
