import {
  ...
  propertyArray,
  referenceArray,
  returnValueDataFlowEdge,
  stringArray,
  stringOrNull,
  stringValue,
} from "./analysis/graph-normalization.js";
import {
  callEdgeKey,
  callEdgeMatches,
  callSiteDisplay,
  callSiteMatchesTarget,
  compareCallEdge,
  compareCategory,
  compareDataFlowEdge,
  compareLineMatch,
  ...
  recordTextMatches,
  removeInPlace,
  snippetForPatternCandidate,
  stringIncludes,
} from "./analysis/graph-query.js";
import type {
