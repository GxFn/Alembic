...
|-----|------------|---------|
| **VS Code** | MCP | `.vscode/mcp.json` for Copilot / Agent Mode access to Alembic MCP tools |
...
- **MCP config**: `alembic setup` writes `.vscode/mcp.json`
- **Agent Mode**: use Alembic MCP tools for knowledge search, Guard checks, and candidate Recipe submission
- **Copilot instructions**: generate `.github/copilot-instructions.md` with Alembic project conventions
